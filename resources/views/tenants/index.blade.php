...
<head>
    ...
    <title>テナント管理 - {{ config('app.name') }}</title>
            ...
            <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center space-x-4">
                        <a href="{{ route('tenant.dashboard') }}" class="text-sm text-blue-600 hover:text-blue-800">
                            マイダッシュボード
                        </a>
                                    ...
                                    @forelse($tenants as $tenant)
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                {{ $tenant->created_at->format('Y年m月d日') }}
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <a href="{{ route('tenants.show', $tenant) }}" class="text-blue-600 hover:text-blue-900 mr-3">
                                                    詳細
                                                </a>
                                                <a href="{{ route('tenants.switch', $tenant) }}" class="text-indigo-600 hover:text-indigo-900">
                                                    切替
                                                </a>
                                            </td>
                                        </tr>
